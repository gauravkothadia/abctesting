...
public class VisaConfirmationSteps {
    ...
    public void iClickOnAcceptAdditionalCookiesButton() {
        new StartPage().clickOnAcceptCookies();
    }

    @And("I clicked on Hide this message button")
    public void iClickedOnHideThisMessageButton() {
        new StartPage().clickOnHideThisMessageText();
    }
}
